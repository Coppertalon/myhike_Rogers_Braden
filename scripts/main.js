...
function readQuote() {
    db.collection("quotes").doc("tues").onSnapshot(tuesDoc => {
        console.log("current document data:" + tuesDoc.data());
        document.getElementById("quote_fill").innerHTML = tuesDoc.data().quote;
    })
}
readQuote()
